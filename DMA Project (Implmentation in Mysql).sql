...
CREATE TABLE Desk (
  ...
  Desk_Location VARCHAR(255) NOT NULL,
  FOREIGN KEY (Building_id) REFERENCES Building(id)
  
);

CREATE TABLE Conference_Room (
  Conference_Room_ID INT NOT NULL PRIMARY KEY,
  Building_ID INT NOT NULL,
  Conference_Room_Number INT NOT NULL,
  Conference_Room_Location VARCHAR(255) NOT NULL,
  Capacity INT NOT NULL,
  FOREIGN KEY (Building_id) REFERENCES Building(id)
);

CREATE TABLE Desk_Booking (
  Desk_Booking_ID INT NOT NULL PRIMARY KEY,
  Building_ID INT NOT NULL,
...
CREATE TABLE Conference_Room_Booking (
  Conference_Room_Booking_ID INT NOT NULL PRIMARY KEY,
  Conference_Room_ID INT NOT NULL,
  Booking_ID INT NOT NULL,
  FOREIGN KEY (Conference_Room_Booking_ID) REFERENCES Room_type(room_id)
);

CREATE TABLE Desk_Availability (
  Desk_Availability_ID INT NOT NULL PRIMARY KEY,
  Conference_Room_Booking_ID INT NOT NULL,
  Desk_ID INT NOT NULL,
  Date DATE NOT NULL,
...
CREATE TABLE Conference_Room_Availability (
  Conference_Room_Availability_ID INT NOT NULL PRIMARY KEY,
  Conference_Room_ID INT NOT NULL,
  Date DATE NOT NULL,
